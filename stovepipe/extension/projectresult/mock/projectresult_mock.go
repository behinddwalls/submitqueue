...
// Source: projectresult.go
//
// Generated by this command:
//
//	mockgen -source=projectresult.go -destination=mock/projectresult_mock.go -package=mock
//
...
import (
	...
	projectresult "github.com/uber/submitqueue/stovepipe/extension/projectresult"
...
func (m *MockFactory) For(cfg projectresult.Config) (projectresult.Resolver, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "For", cfg)
	ret0, _ := ret[0].(projectresult.Resolver)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
